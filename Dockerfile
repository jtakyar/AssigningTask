...
RUN pwd
RUN git clone https://github.com/jtakyar/AssigningTask.git
RUN pwd
...
EXPOSE 8181
RUN pwd
RUN cp target/Spring201-0.0.1-SNAPSHOT.war /usr/local/tomcat/webapps/Spring201-0.0.1-SNAPSHOT.war
